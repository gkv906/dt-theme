...
<main id="primary" class="site-main container mx-auto px-4 py-16 bg-[#050505] min-h-[60vh]">
    <div class="text-center mb-12">
        <span class="text-xs uppercase tracking-[0.35em] text-[#C8A46A] block mb-2"><?php esc_html_e( 'Chronicles', 'dt-ecommerce-theme' ); ?></span>
        <?php
        the_archive_title( '<h1 class="font-serif text-4xl md:text-5xl text-white">', '</h1>' );
        the_archive_description( '<div class="archive-description text-xs text-[#a3a3a3] mt-2">', '</div>' );
        ?>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        if ( have_posts() ) :
            ...
            echo '<p class="text-center text-[#a3a3a3]">' . esc_html__( 'No posts found in this archive.', 'dt-ecommerce-theme' ) . '</p>';
        endif;
        ?>
    </div>
</main>
